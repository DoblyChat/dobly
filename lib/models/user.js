...
schema.methods.isMemberOf = function(collaborationObject) {
	if (!this.groupId.equals(collaborationObject.groupId)) {
		return false;
	}
	...
	return collaborationObject.members.users.some(function(userId) {
		return thisId.equals(userId);
	});
};
