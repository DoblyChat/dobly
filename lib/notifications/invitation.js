...
module.exports = (function() {
	...
	function generateMessage(invitation, user, group) {
		var message = 
			newLine('Hello,') +
			newLine() +
			newLine(user.getFullName() + ' has invited you to use Dobly. Use the link below to accept your invitation:') +
			newLine() +
			newLine(process.env.INVITATION_URL + invitation._id) +
			newLine() + 
			newLine('Dobly helps you collaborate with your team or group. You can learn more about Dobly at our website:') +
			newLine() +
			newLine(process.env.HOME_PAGE_URL) +
			newLine() +
			newLine('Thank you and have a wonderful day,') +
			newLine() +
