describe("conversation", function() {
    ...
    describe("creation", function() {
        ...
        it("pushes messages", function() {
            ...
            expect(conversation.messages().length).toBe(2);
            expect(conversation.messages()[0].lines[0]).toEqual("alpha");
            expect(conversation.messages()[1].lines[0]).toEqual("beta");
        });
    });
    ...
    describe("last messages", function() {
        it("3 messages", function() {
            ...
            expect(conversation.lastMessages()[0].lines[0]).toBe("beta");
            expect(conversation.lastMessages()[1].lines[0]).toBe("charlie");
        });
        ...
        it("2 messages", function() {
            ...
            expect(conversation.lastMessages().length).toBe(2);
            expect(conversation.lastMessages()[0].lines[0]).toBe("alpha");
            expect(conversation.lastMessages()[1].lines[0]).toBe("beta");
        });
