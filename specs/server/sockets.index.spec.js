describe('Socket', function(){
    ...
    describe('Configure', function(){
		...
		beforeEach(function(){
			...
			taskIoMock = buildMock('./task_io', 'add', 'remove', 'toggleComplete', 'updateContent', 'assign');
		...
		describe('on socket connection', function(){
			...
			describe('binds to events', function(){
				...
				it('removes a task', function(){
					fire('remove_task');
					expectSessionTouchCalled();
					expect(taskIoMock.remove).toHaveBeenCalledWith(socketMock, data);
				});
				...
				it('updates task content', function(){
					fire('assign_task');
					expectSessionTouchCalled();
					expect(taskIoMock.assign).toHaveBeenCalledWith(socketMock, data);
				});
