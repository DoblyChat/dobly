    ...
    describe('Task - integration', function(){
        ...
        beforeEach(function(done){
            ...
            CollaborationObject.create({
                ...
                mockery.registerMock('../models/task', Task);
                mockery.registerMock('./collaboration_object', CollaborationObject);
                mockery.registerMock('./unread_marker', UnreadMarker);
        ...
        it('adds a task', function(done){
            ...
            taskIo.add(socketMock, sockets, data, function(task){
                waitUntil(function(callback){
                    UnreadMarker.find({ collaborationObjectId: collaborationObjectId }, function(err, markers){
                        callback(markers.length > 0);
                    });
                },
                function(){
